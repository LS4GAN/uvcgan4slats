...
In this repo, we discribe the application of `UVCGAN` ([Paper][uvcgan_paper], [repo][uvcgan_repo]), an unpaired image-to-image translation algorithm, to a scientific dataset.
